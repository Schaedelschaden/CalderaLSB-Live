...
-----------------------------------
local m = Module:new("ZoKhu_Blackcloud")

local mobToReplaceName = "ZoKhu_Blackcloud"

m:addOverride(string.format("xi.zones.Beadeaux.mobs.%s.onMobSpawn", mobToReplaceName), function(mob)
